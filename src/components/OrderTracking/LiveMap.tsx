  ...
  return (
    <>
      {order.status !== "Delivered" && order.status !== "Cancelled" && (
        /* ĐÃ ĐỔI: Chuyển container sang màu trắng sáng nhẹ, tăng độ mượt */
        <div
        ...
        >
          {liveLocation && liveLocation.lat !== 0 ? (
            <MapContainer
              ...
              zoomControl={false}
            >
              {/* ĐÃ ĐỔI: Sử dụng tile trắng sáng tối giản (Positron) của CartoDB */}
            ...
            <div className="h-full bg-white flex items-center justify-center">
              <div className="text-center">
                <MapPinIcon className="size-8 text-slate-300 mx-auto mb-2" />
